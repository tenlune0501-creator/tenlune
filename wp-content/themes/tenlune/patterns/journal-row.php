 ...
 * `templates/front-page.html` 에서 이 패턴 참조 줄을 잠시 뺐습니다.
 * 2026-08-30 — 첫 실제 글 발행에 맞춰 front-page.html 의 principles 와 contact 사이에
 * 다시 넣었습니다(M5). query-no-results 문구는 다시 글이 0건이 될 때를 위한 안전장치로 둡니다.
 *
 * @package Tenlune
 */
